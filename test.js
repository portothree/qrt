...
describe('Air Quality Toolkit', () => {
	...
	cases(
		...
		[
			...
			{ name: 'PM2.5:4', values: [0, 12, 0, 0, 0] },
			{ name: 'PM2.5:4', values: [0, 20, 0, 0, 0] },
			{ name: 'PM2.5:3', values: [0, 22, 0, 0, 0] },
			{ name: 'PM2.5:3', values: [0, 25, 0, 0, 0] },
			{ name: 'PM2.5:2', values: [0, 27, 0, 0, 0] },
			{ name: 'PM2.5:2', values: [0, 50, 0, 0, 0] },
			{ name: 'PM2.5:1', values: [0, 52, 0, 0, 0] },
